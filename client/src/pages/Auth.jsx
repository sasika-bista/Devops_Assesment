        ...
        >
          ...
          <div className="w-1/2 shrink-0 px-6 sm:px-8 pt-6 sm:pt-6">
            ...
            <div className="relative flex py-2 items-center mb-3 sm:mb-6">
              ...
              <span className="flex-shrink-0 mx-2 sm:mx-4 text-gray-400 text-[10px] sm:text-sm font-bold uppercase tracking-wider">
                Or
              </span>
              <div className="flex-grow border-t border-gray-200"></div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 sm:py-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md mt-2 disabled:bg-gray-400"
              >
          ...
          <div className="w-1/2 shrink-0 px-8 pt-8">
            <div className="mb-5 sm:mb-8  text-center">
              ...
              <p className="text-gray-500 text-xs sm:text-sm">
                Join to start organizing your tasks.
              </p>
            </div>
          ...
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 sm:p-0">
            ...
            >
              <button
                ...
                className="absolute top-5 right-5 py-2 bg-gray-100 hover:bg-gray-200 transition-colors rounded-full text-gray-500"
              >
                <X className="h-4 w-4" />
              </button>

              <h2 className="text-2xl font-black mb-2 text-gray-900">
                {forgotStep === 1 ? "Reset Password" : "Secure Verification"}
              </h2>
              ...
              {forgotStep === 1 ? (
                <form onSubmit={handleForgotRequest} className="space-y-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl outline-none transition-all font-medium"
                      required
                    />
                  </div>
                  <button
                    ...
                    className="w-full bg-blue-900 hover:bg-blue-800 text-white font-bold py-3.5 rounded-xl transition-all shadow-md mt-4 disabled:bg-gray-400"
                  >
                ...
                <form onSubmit={handleForgotConfirm} className="space-y-4">
                  <div>
                    <label className="text-[10px] font-bold tetx-gray-400 uppercase ml-1 block">
                      Verification Code
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 mt-1 bg-gray-50 border border-gray-200 shadow-sm rounded-xl outline-none text-center font-black tracking-[0.5em] text-xl"
                      required
                    />
                  </div>
                  <div className="mt-4">
                  ...
                  >
                    ...
                    {forgotLoading ? "Verifying..." : "Reset & Confirm"}
                  </button>
                </form>
              )}
            </motion.div>
